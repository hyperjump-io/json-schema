...
const description = "Validates array elements that did not successfully validate against other standard array applicators. Read more: https://www.learnjsonschema.com/2020-12/unevaluated/unevaluateditems/";
...
const interpret = ([schemaUrl, unevaluatedItems], instance, ast, dynamicAnchors, quiet) => {
  ...
  let isValid = true;
  for (const [item, index] of zip(instance.iter(), range(0))) {
...
export default { id, description, compile, interpret, collectEvaluatedItems };
