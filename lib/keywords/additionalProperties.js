...
const interpret = ([propertyNames, propertyPatterns, additionalProperties], json, ast, results) => {
  ...
  if (typeof additionalProperties === "string") {
    return properties.every(([, property]) => Core.interpretSchema(additionalProperties, property, ast, results));
  } else {
