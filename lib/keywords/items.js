...
const description = `Validation succeeds if each element of the instance not covered \
by \`prefixItems\` validates against this schema.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/items/`;
