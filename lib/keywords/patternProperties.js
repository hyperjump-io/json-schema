...
const description = `Validation succeeds if, for each instance name that \
matches any regular expressions that appear as a property name in this keyword’s \
value, the child instance for that name successfully validates against each schema \
that corresponds to a matching regular expression.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/patternproperties/`;
