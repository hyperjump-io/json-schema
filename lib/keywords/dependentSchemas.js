...
const interpret = (dependentSchemas, instance, ast, dynamicAnchors, quiet) => {
  return instance.typeOf() !== "object" || dependentSchemas.every(([propertyName, dependentSchema]) => {
    return !instance.has(propertyName) || Validation.interpret(dependentSchema, instance, ast, dynamicAnchors, quiet);
  });
};
