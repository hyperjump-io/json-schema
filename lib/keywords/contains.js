...
const description = `Validation succeeds if the instance contains an element \
that validates against this schema.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/contains/`;
