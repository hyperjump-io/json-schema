...
const compile = async (schema, ast, parentSchema) => {
  ...
  const minContainsKeyword = Keywords.getKeywordName(schema.dialectId, "https://json-schema.org/keyword/minContains");
  ...
  const maxContainsKeyword = Keywords.getKeywordName(schema.dialectId, "https://json-schema.org/keyword/maxContains");
...
module.exports = { id, compile, interpret, collectEvaluatedItems, collectEvaluatedProperties };
