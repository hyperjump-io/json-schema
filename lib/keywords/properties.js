...
const description = `Validation succeeds if, for each name that appears in both the instance \
and as a name within this keyword’s value, the child instance for that name successfully validates \
against the corresponding schema.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/properties/`;
