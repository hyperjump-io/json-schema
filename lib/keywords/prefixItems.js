...
const description = `Validation succeeds if each element of the instance validates \
against the schema at the same position, if any.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/prefixitems/`;
