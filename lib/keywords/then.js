...
const description = `When if is present, and the instance successfully validates \
against its subschema, then validation succeeds against this keyword if the instance \
