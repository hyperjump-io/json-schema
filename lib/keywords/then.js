...
const description = `When \`if\` is present, and the instance successfully validates against \
its subschema, then validation succeeds against this keyword if the instance also successfully \
validates against this keyword’s subschema.\\
\\
For examples and more information visit https://www.learnjsonschema.com/2020-12/applicator/then/`;
...
export default { id, description, compile, interpret, collectEvaluatedProperties, collectEvaluatedItems };
