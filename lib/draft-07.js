...
JsonSchema.addKeyword(`${schemaVersion}#if`, keywords.ifThenElse);
...
JsonSchema.addKeyword(`${schemaVersion}#readOnly`, keywords.metaData);
...
JsonSchema.addKeyword(`${schemaVersion}#writeOnly`, keywords.metaData);
