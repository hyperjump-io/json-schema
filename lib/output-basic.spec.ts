...
describe("Basic Output Format", () => {
  ...
  describe("$ref", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, 42, BASIC);
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, "foo", BASIC);
  ...
  describe("additionalProperties", () => {
    ...
    test("invalid - multiple errors", async () => {
      registerSchema({ additionalProperties: false }, schemaUri, dialectUri);
      const output = await validate(schemaUri, { foo: 42, bar: 24 }, BASIC);
  ...
  describe("allOf", () => {
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, 3, BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("anyOf", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, true, BASIC);
  ...
  describe("contains", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, [1, 2], BASIC);
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, [1, "foo"], BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("dependentSchemas", () => {
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, { foo: 42, a: true }, BASIC);
  ...
  describe("else", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, 5, BASIC);
  ...
  describe("items", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, [42, 24], BASIC);
  ...
  describe("patternProperties", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, { foo: 42, bar: true }, BASIC);
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, { foo: "a", bar: 42 }, BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("prefixItems", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, [42, "foo"], BASIC);
  ...
  describe("propertyNames", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, { banana: true, pear: false }, BASIC);
    ...
    test("valid", async () => {
      ...
      const output = await validate(schemaUri, { apple: true }, BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("maxLength", () => {
    ...
    test("valid", async () => {
      registerSchema({ maxLength: 2 }, schemaUri, dialectUri);
      const output = await validate(schemaUri, "a", BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("maxProperties", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, { a: 1, b: 2 }, BASIC);
  ...
  describe("multipleOf", () => {
    ...
    test("valid", async () => {
      registerSchema({ multipleOf: 2 }, schemaUri, dialectUri);
      const output = await validate(schemaUri, 4, BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("pattern", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, "banana", BASIC);
    ...
    test("valid", async () => {
      registerSchema({ pattern: "^a" }, schemaUri, dialectUri);
      const output = await validate(schemaUri, "apple", BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("required", () => {
    ...
    test("valid", async () => {
      registerSchema({ required: ["a"] }, schemaUri, dialectUri);
      const output = await validate(schemaUri, { a: 1 }, BASIC);
      expect(output).to.eql({ valid: true });
    });
  });
  ...
  describe("uniqueItems", () => {
    test("invalid", async () => {
      ...
      const output = await validate(schemaUri, [1, 1], BASIC);
  ...
  test("Deeply nested", async () => {
    ...
    const output = await validate(schemaUri, { foo: { bar: 42 } }, BASIC);
