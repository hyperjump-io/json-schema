...
const skip = new Set<string>([
  ...
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|contains illegal char U+302E Hangul single dot tone mark",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|contains illegal char U+302E Hangul single dot tone mark",
  "|draft7|hostname.json|validation of A-label (punycode) host names|contains illegal char U+302E Hangul single dot tone mark",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, right-to-left chars",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, right-to-left chars",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, right-to-left chars",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, left-to-right chars",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, left-to-right chars",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Exceptions that are DISALLOWED, left-to-right chars",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no preceding 'l'",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no preceding 'l'",
  "|draft7|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no preceding 'l'",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing preceding",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing preceding",
  "|draft7|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing preceding",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no following 'l'",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no following 'l'",
  "|draft7|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with no following 'l'",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing following",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing following",
  "|draft7|hostname.json|validation of A-label (punycode) host names|MIDDLE DOT with nothing following",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by Greek",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by Greek",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by Greek",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by anything",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by anything",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Greek KERAIA not followed by anything",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Hebrew GERESH not preceded by anything",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Hebrew GERESH not preceded by anything",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Hebrew GERESH not preceded by anything",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|Hebrew GERSHAYIM not preceded by anything",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|Hebrew GERSHAYIM not preceded by anything",
  "|draft7|hostname.json|validation of A-label (punycode) host names|Hebrew GERSHAYIM not preceded by anything",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no Hiragana, Katakana, or Han",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no Hiragana, Katakana, or Han",
  "|draft7|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no Hiragana, Katakana, or Han",
  "|draft2020-12|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no other characters",
  "|draft2019-09|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no other characters",
  "|draft7|hostname.json|validation of A-label (punycode) host names|KATAKANA MIDDLE DOT with no other characters",
